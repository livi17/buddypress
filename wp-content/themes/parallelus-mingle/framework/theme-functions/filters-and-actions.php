...
if ( ! function_exists( '_theme_data_lookup' ) ) :
	...
	function _theme_data_lookup() {
		...
		*/
		...
		$array_saved = (isset($design_saved_data['design_setting'])) ? $design_saved_data['design_setting'] : array();
		$array_db = (isset($design_db_data['design_setting'])) ? $design_db_data['design_setting'] : array();
		$design_data['design_setting'] = array_merge((array) $array_saved, (array) $array_db);

		$array_saved = (isset($design_saved_data['slideshows'])) ? $design_saved_data['slideshows'] : array();
		$array_db = (isset($design_db_data['slideshows'])) ? $design_db_data['slideshows'] : array();
		$design_data['slideshows'] = array_merge((array) $array_saved, (array) $array_db);

		$array_saved = (isset($design_saved_data['top_graphics'])) ? $design_saved_data['top_graphics'] : array();
		$array_db = (isset($design_db_data['top_graphics'])) ? $design_db_data['top_graphics'] : array();
		$design_data['top_graphics'] = array_merge((array) $array_saved, (array) $array_db);

		$array_saved = (isset($design_saved_data['sidebars'])) ? $design_saved_data['sidebars'] : array();
		$array_db = (isset($design_db_data['sidebars'])) ? $design_db_data['sidebars'] : array();
		$design_data['sidebars'] = array_merge((array) $array_saved, (array) $array_db);

		$array_saved = (isset($design_saved_data['page_headers'])) ? $design_saved_data['page_headers'] : array();
		$array_db = (isset($design_db_data['page_headers'])) ? $design_db_data['page_headers'] : array();
		$design_data['page_headers'] = array_merge((array) $array_saved, (array) $array_db);

		$array_saved = (isset($design_saved_data['page_footers'])) ? $design_saved_data['page_footers'] : array();
		$array_db = (isset($design_db_data['page_footers'])) ? $design_db_data['page_footers'] : array();
		$design_data['page_footers'] = array_merge((array) $array_saved, (array) $array_db);

		$array_saved = (isset($design_saved_data['layouts'])) ? $design_saved_data['layouts'] : array();
		$array_db = (isset($design_db_data['layouts'])) ? $design_db_data['layouts'] : array();
		$design_data['layouts'] = array_merge((array) $array_saved, (array) $array_db);
