...
function insertThemeLink() {
	...
	if (style.className.indexOf("current") != -1) {
		...
		if (styleid != 0 && styleid == "quote" ){
			tagtext = '['+ styleid + ' author="- The Author Name"]The quote to be displayed...[/' + styleid + ']';	
		}
		...
		if (styleid != 0 && styleid == "call_to_action" ){
			tagtext = '['+ styleid + ' title="My Call to Action" tag_line="The tagline of this call to action." arrow="yes" button="Click here!" link="" ]';
		}
