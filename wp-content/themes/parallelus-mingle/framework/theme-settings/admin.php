...
?>
	...
	<p><?php _e('Display your form with the <code>[contact_form]</code> shortcode. You can customize each instance with unique values for <code>to</code>, <code>subject</code> and <code>thankyou</code> in the form. Empty fields use the default settings established in the fields below.' ,THEME_NAME); ?></p>
	<!--<div class="meta-box-sortables metabox-holder">
		<div class="postbox">
			<div class="handlediv" title="Click to toggle"><br></div><h3 class="hndle"><span><?php _e('Options', THEME_NAME); ?></span></h3>
			<div class="inside" style="display: none;">-->
