...
class design_settings_admin extends framework_admin_object_ambassador_1 {
	...
	function validate_sumbission() {
		...
		/*if ($this->navigation == 'design_settings') {
			...
			$this->fields = array(
				...
				'array' => array(
					...
					'layout' => array('header', 'footer', 'default', 'home', 'page', 'post', 'blog', 'category', 'author', 'tag', 'date', 'search', 'error', 'bp', 'bp-activity', 'bp-blogs', 'bp-forums', 'bp-groups', 'bp-groups-single', 'bp-members', 'bp-members-single', 'bp-register', 'bp-activate' )
				)
			);
		...
		if ($this->navigation == 'design_settings') {
			...
			$custom_context_list = array_merge( isset($custom_context_list['manual'])? (array)$custom_context_list['manual'] : array(), (array)$custom_context_list['auto'] );
	...
	function load_admin_js() {
        ...
        wp_register_script( 'jquery-ui', $js.'jquery-ui-1.10.3.custom.min.js', array('jquery'), '1.10.3', true);
