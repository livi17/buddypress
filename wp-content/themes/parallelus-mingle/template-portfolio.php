...
<section class="content-post-list clearfix">
	...
	while( $portfolio_query->have_posts() ) : $portfolio_query->the_post();
		...
		$excerptLength = (isset($sc['excerpt_length'])) ? (int)$sc['excerpt_length'] : 50;
		...
		$margin = 32;
		$image_container = 14; // accounts for padding and borders
		$content_width = (isset($sc['content_width'])) ? (int) $sc['content_width'] : 990;
		...
		$class = '';
		$sc['link'] = (isset($sc['link'])) ? $sc['link'] : 'lightbox';
