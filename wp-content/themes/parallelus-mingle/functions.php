...
$themeInfo = (function_exists('wp_get_theme')) ? wp_get_theme() : get_theme_data(TEMPLATEPATH . '/style.css');
...
if (!isset($content_width)) $content_width = 734;							// Max content width (if using full width layout set to 990)
